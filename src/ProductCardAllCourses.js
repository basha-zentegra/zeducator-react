...
function ProductCardAllCourses({ product , lessons}) {

    const navigate = useNavigate();

  const handleClick = (lessons) => {
    navigate("/pricing", { state: { product, lessons } }); // Pass product data to CoursePage
  };
    return (
  ...
  export default ProductCardAllCourses;
